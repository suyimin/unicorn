package com.gy.amobile.hslibrary.adaptive.config;

import android.content.Context;
import android.content.pm.ApplicationInfo;
import android.content.pm.PackageManager;

import com.gy.amobile.hslibrary.adaptive.utils.ScreenUtils;
import com.sdk.util.LogUtil;


public class LayoutConifg {

    private static LayoutConifg sIntance = new LayoutConifg();


    private static final String KEY_DESIGN_WIDTH = "key_width";
    private static final String KEY_DESIGN_HEIGHT = "key_height";
    ...
    public LayoutConifg useDeviceSize() {
        useDeviceSize = true;
        return this;
    }


    public static LayoutConifg getInstance() {
        return sIntance;
    }
